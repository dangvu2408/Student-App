                ...
                child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                            padding: const EdgeInsets.only(
                                left: 15, right: 15, top: 15, bottom: 90),
                                          ...
                                          Expanded(
                                            child: TableCalendar(
                                              ...
                                              calendarFormat:
                                                  CalendarFormat.week,
                                              firstDay:
                                                  DateTime.utc(2010, 10, 15),
                                              lastDay:
                                                  DateTime.utc(2050, 10, 15),
                                      ...
                                      children: [
                                          ...
                                          children: [
                                            Container(
                                              ...
                                              child: const Image(
                                                ...
                                                height: 45,
                                                image: AssetImage(
                                                    'assets/images/settingcalendar.png'),
                                              ),
                                            ),
                                            Text(
                                              'Sắp xếp TKB',
                                            ...
                                            Text(
                                              'Sắp xếp, chỉnh sửa thời khóa biểu',
                                              textAlign: TextAlign.center,
                                              style: TextStyle(
                                                fontSize: 16,
                                                fontFamily: 'SFPro',
                                        ...
                                        Container(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              'Tra cứu học phần trong chương trình đào tạo',
                                              textAlign: TextAlign.center,
                                              style: TextStyle(
                                                fontSize: 16,
                                                fontFamily: 'SFPro',
                                        ...
                                        Container(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              'Tra cứu thông tin về học phí, công nợ',
                                              textAlign: TextAlign.center,
                                              style: TextStyle(
                                                fontSize: 16,
                                                fontFamily: 'SFPro',
